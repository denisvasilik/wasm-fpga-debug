...
set project_name "WasmFpgaDebug"
...
set obj [get_filesets sources_1]
set files_vhd [list \
 [file normalize "${project_src}/WasmFpgaDebug.vhd" ]\
 [file normalize "${project_src}/WasmFpgaDebugPackage.vhd" ]\
...
set obj [get_filesets sources_1]
set_property -name "top" -value "WasmFpgaDebug" -objects $obj
set_property -name "top_auto_set" -value "0" -objects $obj
set_property -name "top_file" -value "${project_src}/WasmFpgaDebug.vhd" -objects $obj
...
set files [list \
 "[file normalize "${project_tb}/tb_WasmFpgaDebug.vhd"]"\
 "[file normalize "${project_tb}/tb_UartModel.vhd"]"\
 "[file normalize "${project_resources}/wasm_fpga_uart_wishbone.vhd"]"\
 "[file normalize "${project_resources}/wasm_fpga_uart_header.vhd"]"\
...
set obj [get_filesets sim_1]
set_property "top" "tb_WasmFpgaDebug" $obj
