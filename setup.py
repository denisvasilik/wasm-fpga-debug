...
setuptools.setup(
    ...
    package_data={},
    data_files=[
        ("wasm-fpga-debug/package", ["package/component.xml"]),
        ("wasm-fpga-debug/package/bd", ["package/bd/bd.tcl"]),
        ("wasm-fpga-debug/package/xgui", ["package/xgui/wasm_fpga_uart_interconnect_v1_0.tcl"]),
        ("wasm-fpga-debug/src", ["src/WasmFpgaDebug.vhd"]),
        (
            "wasm-fpga-debug/tb",
            [
                "tb/tb_FileIo.vhd",
        ...
        ("wasm-fpga-debug", ["CHANGELOG.md", "AUTHORS", "LICENSE"]),
    ],
    setup_requires=[],
    install_requires=[],
    entry_points={},
